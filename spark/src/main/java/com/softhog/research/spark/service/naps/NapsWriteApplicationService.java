...
@Default
@RequestScoped
public class NapsWriteApplicationService implements Service
{
    /**
    ...
    public Object process( Object input )
    {
        ...
        // & lamba
        ApplApplication appl = (ApplApplication) input;
                        ...
                        | HeuristicMixedException | HeuristicRollbackException e )
        {
            ...
            {
                throw new KVException( "NWAS_RB_ERR", e, e.getMessage() );
            }

            throw new KVException( "NWAS_ERR", e, e.getMessage() );
        }
    }
}
